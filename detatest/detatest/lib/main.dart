...
Future<http.Response> postMessage(
  ...
  const url = "https://database.deta.sh/v1/b097bqyc/asdf/items";
  ...
  return await http.post(
    uri,
    headers: {
      'X-API-Key': 'b097bqyc_HQyYobovWWfryJBa1S44CTL6RREX1jp2',
...
Future<http.Response> queryMessages() async {
  const url = "https://database.deta.sh/v1/b097bqyc/asdf/query";
  final uri = Uri.parse(url);
  return await http.post(
    uri,
    headers: {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => {
          _incrementCounter(),
          postMessage("Message $_counter", _counter, "THOMAS WILSON"),
          queryMessages(),
        },
        tooltip: 'Increment',
